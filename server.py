...
def main():
    ...
    if prompt := st.chat_input():
        ...
        try:
            response = requests.post('https://3902-2600-1702-56e1-b120-d47a-1c22-8126-9b94.ngrok-free.app/question', json={'question': str(prompt)}, headers={'Content-Type': 'application/json'})
            json = response.json()
